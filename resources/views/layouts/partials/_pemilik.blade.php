...
<a href="{{ route('pemilik.kategori') }}"
    class="flex items-center p-3 mb-2 {{ request()->routeIs('pemilik.kategori') ? 'bg-pos-accent text-white' : 'text-stone-100 hover:text-white hover:bg-stone-600' }} rounded-lg transition">
    <i class="fa fa-tags mr-3 w-5 text-center"></i> Kategori
</a>

<a href="{{ route('pemilik.produk') }}"
    class="flex items-center p-3 mb-2 {{ request()->routeIs('pemilik.produk') ? 'bg-pos-accent text-white' : 'text-stone-100 hover:text-white hover:bg-stone-600' }} rounded-lg transition">
...
<a href="/staff"
    class="flex items-center p-3 mb-2 {{ request()->is('staff*') ? 'bg-pos-accent text-white' : 'text-stone-100 hover:text-white hover:bg-stone-600' }} rounded-lg transition">
