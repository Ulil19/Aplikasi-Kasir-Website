...
<a href="/dashboard"
    class="flex items-center p-3 mb-2 {{ request()->is('dashboard') ? 'bg-pos-accent text-white' : 'text-stone-100 hover:text-white hover:bg-stone-600' }} rounded-lg transition">
...
<a href="/riwayat"
    class="flex items-center p-3 mb-2 {{ request()->is('riwayat*') ? 'bg-pos-accent text-white' : 'text-stone-100 hover:text-white hover:bg-stone-600' }} rounded-lg transition">
